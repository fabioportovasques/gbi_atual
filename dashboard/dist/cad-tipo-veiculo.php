...
<html lang="en">
    <head>
        ...
        <title>Cadastrar Marcas/Modelos de veículo</title>
...
<body class="sb-nav-fixed">
   ...
   <div class="container formulario">
    ...
    <br />
                                           ...
                                           <h2 class="text-center">Cadastrar Marcas/Modelos de Veículo</h2><br />
                        ...
                        <!--Início da coluna-->         
                          <div class="marcado1r col-md-4">
                                       <div class="col">
                                                ...
                                                <input type="text" name="marca_veiculo" class="form-control" placeholder="Marca Veículo" 
                                                target="_blank" data-toggle="tooltip"  title="Insira a Marca, ex: 'chevrolet'" value="<?php echo $item['marca_veiculo'] ?>">
                                           </div>
                                 ...
                                 <div class="marcado1r col-md-4"> 
                                            <div class="form-group">
                                                <div class="col">
                                                    ...
                                                    <input type="text" name="modelo_veiculo" id="modelo_veiculo" class="form-control" placeholder="Insira o modelo"  
