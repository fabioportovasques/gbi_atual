...
<html lang="en">
    <head>
        ...
        <title>Consultar Proprietário</title>  
...
<body class="sb-nav-fixed">
   ...
   <div class="container formulario">
    ...
    <br />
                                           ...
                                           <h2 class="text-center">Consultar Proprietario</h2><br />
                                           <hr />
                                    ...
                                    <div class="row">
                                                              ...
                                                              <label for="proprietario" class="labelCpf">CPF</label>
                                                                <div class="input-group mb-3 inputCpf">
                                                                          ...
                                                                          <div class="input-group-append">
                                                                            <button type="submit" class="btn btn-outline-secondary" type="button" data-toggle="tooltip" data-placement="top" title="Vinclular novo proprietario" id="button-addon2" name="pesquisar" value="pesquisar">
                                              ...
                                              <div class="col-md-4">
                                                             <div class="col">
                                                                           ...
                                                                           <input type="text" readonly name="nome_cliente" class="form-control" value="<?php echo $item['nome_cliente']  ?>">
                                              ...
                                              <div class="col-md-4">
                                                             <div class="col">
                                                                           ...
                                                                           <!--<input type="text" onClick="this.parentNode.remove();" name="nome_cliente" id="remove" class="form-control" placeholder="Nome Proprietário"  autocomplete="off" value= "<?php echo $item['nome_cliente']; ?>" >-->
                                                                           <input type="text" readonly name="sobrenome_cliente" class="form-control" value="<?php echo $item['sobrenome_cliente']  ?>">
                                                                           <input type="hidden" name="cliente_codcliente" id="cliente_codcliente" class="form-control" placeholder="Cod Proprietário"  autocomplete="off" value= "<?php echo $item['cliente_codcliente']; ?>" >
                                                                 </div>
