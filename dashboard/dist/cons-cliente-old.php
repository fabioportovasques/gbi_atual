...
<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #343363">
            <a class="navbar-brand" href="index.html">Consultar Cliente</a>
   ...
   <!--Início container--> <div class="container formulario">
                ...
                <!--Início da linha-->     <div class="row">
                                ...
                                <!--Início da coluna-->          <div class="marcador col-md-4">
                                                                                    ...
                                                                                    <div class="col">
                                                                                        <label > CPF/CNPJ</label>
                                                                                          ...
                                                                                          <span class="campo-obrigatorio">*</span>
                                                                                           <input type="text" name="cpf_cliente" id="cpf_cnpjewe" class="form-control" target="_blank" data-toggle="tooltip"  title="Insira um CPF/CNPJ Válido no formato(00000000000000) sem espaço ou pontos" placeholder="CPF" onblur="validar(getElementById('cpf_cnpj').value)"  autocomplete="off" value="<?php echo $item['cpf_cliente']; ?>" >    
                         ...
                         <div class="col-md-1 flex-row-reverse">
                                   <div class="item4">
                                        <button type="submit" name="pesquisar" value="pesquisar" class="btn  btn-light btn-block"  data-toggle="tooltip"  title="Pesquise Aqui"><i class="glyphicon glyphicon-search"></i> </button>                                                       
                                    </div>
                         <!--Fim da coluna-->                                                
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="   col">
                                                                                           ...
                                                                                           <span class="campo-obrigatorio">*</span>
                                                                                              ...
                                                                                              <input type="text" name="nome_cliente" id="nome_cliente" class="form-control" value="<?php echo $item['nome_cliente']; ?>">   
                                 ...
                                 <!--Início da coluna-->         <div class="marcado1r col-md-5">

                                                                               <div class="form-group">
                                                                                    <div class="   col">
                                                                                        <label > Sobrenome</label>
                                                                                       <span class="campo-obrigatorio">*</span>
                                                                                        <input type="text" name="nome_cliente" id="nome_cliente" class="form-control" value="<?php echo $item['sobrenome_cliente']; ?>"  placeholder="Sobrenome" >    
                                ...
                                <!--Início da coluna-->          <div class="marcador1 col-md-4">
                                                                              ...
                                                                              <div class="form-group">
                                                                                    <div class="   col">
                                                                                        ...
                                                                                        <span class="campo-obrigatorio">*</span>
                                                                                        <input type="text" name="telefone1_cliente" id="telefone1_cliente" class="form-control" placeholder="Telefone" value="<?php echo $item['telefone1_cliente']; ?>" autocomplete="off" >    
                                                                                    </div>
                                                                                </div>
                                 ...
                                 <!--Início da coluna-->          <div class="marcador1 col-md-3">
                                                                              ...
                                                                              <div class="form-group">
                                                                                    <div class="   col">
                                                                                        ...
                                                                                        <span class="campo-obrigatorio"></span>
                                                                                        <input type="text" name="telefone2_cliente" id="telefone2_cliente" class="form-control" placeholder="Telefone" value="<?php echo $item['telefone2_cliente']; ?>" autocomplete="off" >    
                                                                                    </div>
                                                                                </div>
                                       ...
                                       <!--Início da coluna-->    <div class="marcador1 col-md-3">
                                                                              ...
                                                                              <div class="form-group">
                                                                                    <div class="   col">
                                                                                        <label > Rua</label>
                                                                                        <span class="campo-obrigatorio"></span>
                                                                                        <input type="text" name="rua_cliente" id="rua_cliente" class="form-control " value="<?php echo $item['rua_cliente']; ?>" autocomplete="off"  >    
                                          ...
                                          <!--Início da coluna-->    <div class="marcador1 col-md-5">
                                                                       ...
                                                                       <div class="form-group">
                                                                                    <div class="   col">
                                                                                        <label > Bairro</label>
                                                                                        <span class="campo-obrigatorio"></span>
                                                                                        <input type="text" name="bairro_cliente" id="bairro_cliente" readonly required class="form-control" value="<?php echo $item['bairro_cliente']; ?>"autocomplete="off" value="<?php echo $item['bairro_cliente']; ?>" placeholder="bairro">    
               ...
               <br />
                ...
                <!--Início da linha-->      <div class="row">
                                ...
                                <!--Início da coluna-->     <div class="bot1 col-md-2">
                                                                       <!-- <a href="update-cliente.phpid=<?php echo $item['codcliente']; ?>" class="btn btn-warning btn-block"  role="button">Salvar Alterações</a>-->
                                                                        <button class="btn btn-warning btn-block" type="submit">Salvar Alterações</button>
                                 <!--Fim da coluna-->       </div>


                                 <!--Início da coluna-->     <div class="bot1 col-md-2">
                                                                        <input class="btn btn-warning container btn-block" type="submit" name="excluir-cliente"  value="Desativar">
                                <!--Fim da coluna-->      </div>                                
