...
<body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #343363">
            <a class="navbar-brand" href="index.html">Consultar Veículo</a>
   ...
   <!--Início container--> <div class="container formulario">
    ...
    <br />
                                        ...
                                        <div class="row">
                                                                ...
                                                                <!--Início da coluna-->         
                                                                <div class="marcado1r col-md-3">
                                                                  <form action=""  method="POST" name="actionJava"> 
                                                                                     <div class="col">
                                                                                          <label for="proprietario">Proprietário</label>
                                                                                         <input type="text" name="propri_veiculo" id="propri_veiculo" class="form-control" placeholder="CPF Proprietário"  autocomplete="off">
                                                                               </div>
                         ...
                         <div class="col-md-1 flex-row-reverse">
                                   <div class="item2">
                                        ...
                                        <a class="btn  btn-light btn-block" href="#" data-toggle="tooltip"  title="Vincular novo Proprietário"><i class="glyphicon glyphicon-share-alt"></i></a>                                                       
                                    </div>
                         <!--Fim da coluna-->                                                
                                      ...
                                      <!--Início da coluna-->        
                                       <div class="marcado1r col-md-8">
                                                   <div class="col">
                                                                  <label for="proprietario">Nome do Proprietário</label>
                                                                 <input type="text" name="nome_cliente" id="nome_cliente" class="form-control" placeholder="Nome Proprietário"  autocomplete="off" value= "<?php echo $item['nome_cliente']; ?>" >
                                                  </div>
                                ...
                                <!--Início da coluna-->          <div class="marcador1 col-md-3">
                                            ...
                                            <div class="form-group">
                                                <div class="col">
                                                    ...
                                                    <input type="text" name="placa_veiculo" id="placa_veiculo" class="form-control" placeholder="Insira a Placa" target="_blank" data-toggle="tooltip" value="<?php echo $item['placa_veiculo']; ?>" title="Insira a placa para pesquisar">    
                                                </div>
                                            </div>
                ...
                <!--Início da linha-->      <div class="row">
                                ...
                                <!--Início da coluna-->     <div class="bot1 col-md-2">
                                                                        <button class="btn btn-warning btn-block" type="submit" onclick="selecionaAction('update-veiculo');" >Salvar Alterações</button>
                                 <!--Fim da coluna-->       </div>
