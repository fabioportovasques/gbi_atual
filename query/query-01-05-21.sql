...
insert into  ano (cod_ano,ano) values (null,"2004");
...
SELECT COUNT(*) AS total from servicos  where proxima_troca <current_date() AND 
proxima_troca between now() - interval 40 day AND now() < current_date()
group by veiculo_cod_veiculo, nome_cliente, sobrenome_cliente having max(proxima_troca) < current_date();
...
Funcionando, query que conta o numero de veiculos vencidos
...
*/                      
     ...
     SELECT
            ...
            /*
				Inner join entre clientesm veiculos e servicos
            */
            ...
            SELECT * FROM cliente WHERE cpf_cliente = '020.418.840-70' ;
...
/* juncao de tipo_veiculo com marca funcionando*/
...
/* juncao de veiculo + marca + modelo funcionando*/    
...
/* junções de tipo_veiculo + marca + modelo + ano funcionando*/
