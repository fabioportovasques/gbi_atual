...
--
-- Host: localhost:3306
-- Tempo de geração: 04/08/2021 às 13:31
...
CREATE TABLE `ano` (
  ...
  `ano` varchar(20) COLLATE latin1_general_ci NOT NULL
...
(55, 'Yago Alexandre ', 'Elias Teixeira', '9435055476', '94989121733', '274.464.889-21', '', 'Rua João Pessoa', 456, 'Marabá', 'PA', '9875-11-17', 'masculino', 'Belo Horizonte', 68503200),
(56, 'Leandro Ruan ', 'Carvalho', '9128803913', '91986597731', '446.975.589-36', '', 'Quadra Onze', 5454, 'Ananindeua', 'PA', '', 'masculino', 'Icuí-Guajará', 67125847),
(57, 'Carlos Sebastião ', 'Nelson Viana', '5327661383', '53981995055', '609.694.722-00', '293828039', 'Rua Buarque de Macêdo', 345, 'Rio Grande', 'RS', '1986-11-17', 'masculino', 'Hidráulica', 96211324),
(58, 'Cláudia Daiane', ' Laís Fogaça', '6328288902', '', '140.630.781-59', '', 'Quadra ARNO 22 Alameda 1', 4234, 'Palmas', 'TO', '1990-08-12', 'femenino', 'Plano Diretor Norte', 77001158);
...
CREATE TABLE `marca_veiculo` (
  `codmarca_veiculo` int NOT NULL,
  `marca_veiculo` varchar(100) COLLATE latin1_general_ci DEFAULT NULL,
  `tipo_veiculo_codtipo_veiculo` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

--
-- Fazendo dump de dados para tabela `marca_veiculo`
--

INSERT INTO `marca_veiculo` (`codmarca_veiculo`, `marca_veiculo`, `tipo_veiculo_codtipo_veiculo`) VALUES
(9, ' Kia Motors', 1),
(15, 'agrale', 1),
(142, 'ASIA MOTORS', 1),
(1, 'chevrolet', 1),
...
--
-- Estrutura para tabela `modelo_veiculo`
--

CREATE TABLE `modelo_veiculo` (
  `codmodelo_veiculo` int NOT NULL,
  `modelo_veiculo` varchar(200) COLLATE latin1_general_ci DEFAULT NULL,
  `marca_veiculo_codmarca_veiculo` int NOT NULL,
  `ano_cod_ano` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

--
-- Fazendo dump de dados para tabela `modelo_veiculo`
--

INSERT INTO `modelo_veiculo` (`codmodelo_veiculo`, `modelo_veiculo`, `marca_veiculo_codmarca_veiculo`, `ano_cod_ano`) VALUES
(22, '1720 3-Eixos 2p (diesel)', 12, 16),
(11, 'AGILE LT 1.4 MPFI 8V FlexPower 5p gasolina', 1, 20),
(40, 'AM-825 Luxo 4.0 Diesel', 142, 1),
(23, 'Atego 1418 3-Eixos 2p (diesel)', 12, 14),
(39, 'Besta Furgão Grand 3.0 Diesel', 9, 24),
(20, 'BIZ 125 ES/ ES F.INJ./ES MIX F.INJECTION', 2, 16),
(21, 'CBR 600 RR', 2, 25),
(37, 'COMPASS LIMITED 2.0 4x2 Flex 16V Aut. gasolina', 17, 24),
(19, 'Creta Attitude Plus 1.6 16V Flex Aut.gasolina', 6, 23),
(12, 'EcoSport 100 Anos 1.5 Flex 5p Aut gasolina', 5, 23),
(45, 'FOISON 1.3 16V 85cv 2p. Gasolina', 147, 19),
(15, 'Gol (novo) 1.0 Mi Total Flex 8V 2p gasolina', 4, 17),
(16, 'JETTA Comfortline 2.0 T.Flex 8V 4p Tipt.gasolina', 4, 19),
(13, 'Ka 1.5 100 Anos Flex 5p Aut. gasolina', 5, 23),
(17, 'ONIX HATCH Joy 1.0 8V Flex 5p Mec. gasolina', 1, 22),
(14, 'Ranger TROPIVAN 2.5 16V 4X2 Flex.gasolina', 5, 24),
(18, 'UNO ATTRACTIVE 1.0 Fire Flex 8V 5p. gasolina', 3, 18),
(24, 'VOLARE CINCO ESCOLAR (diesel)(E5)', 13, 21);

-- --------------------------------------------------------

--
-- Estrutura para tabela `proxima_troca`
--

CREATE TABLE `proxima_troca` (
  `codproxima_troca` int NOT NULL,
  `proxima_troca` datetime DEFAULT NULL,
  `servicos_cod_servicos` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
(5, '2021-04-06', '2022-04-06', 'teste5', 3131, 'teste1', 'teste2', '1 LT', '70000', 'sim', 'sim', 'ok', 'teste3', 8, NULL, 'sim', 7),
(6, '2021-04-06', '2022-04-06', '3 LT', 70000, 'teste1', 'teste2', 'sim', 'sim', 'sim', 'sim', 'ok', 'teste3', 12, NULL, 'teste5', 14),
(7, '2021-04-06', '2022-04-06', 'teste5', 534534, 'teste1', 'teste2', '1 LT', '87000', 'sim', 'sim', 'ok', 'teste3', 5, NULL, 'sim', 9),
(8, '2021-04-06', '2022-04-06', 'teste5', 543543, 'teste1', 'teste2', '3 LT', '86000', 'nao', 'nao', 'ok', 'teste3', 13, NULL, 'nao', 16),
(9, '2021-04-06', '2022-04-06', 'teste5', 543534, 'teste1', 'teste2', '2 LT', '56000', 'nao', 'nao', 'ok', 'teste3', 14, 'nao', 'nao', 20),
...
(87, '2021-08-03', '2022-08-03', '3', 345678, 'teste2', 'teste1', 'nao', 'nao', 'sim', 'sim', 'tudo ok', 'teste3', 18, 'teste5', 'teste4', 27),
(88, '2022-04-06', '2023-04-06', '3.5', 100000, 'teste2', 'teste1', 'sim', 'sim', 'sim', 'sim', 'tudo ok', 'teste3', 12, 'teste5', 'teste4', 14),
(89, '2021-08-03', '2022-08-03', '1.5', 23514, 'Teste 1', 'Teste2', 'sim', 'nao', 'sim', 'sim', 'Ok', 'Teste3', 12, 'Teste5', 'Teste3', 54),
(90, '2021-08-03', '2022-08-03', '3', 67000, 'teste2', 'teste1', 'nao', 'nao', 'nao', 'nao', 'e2e23e', 'teste3', 7, 'teste5', 'teste3', 6),
(91, '2021-08-03', '2022-08-03', '2', 45678, 'teste2', 'teste1', 'sim', 'sim', 'sim', 'sim', 'ok', 'teste3', 9, 'teste5', 'teste3', 8),
(92, '2021-08-03', '2022-08-03', '2', 35000, 'teste2', 'teste1', 'sim', 'sim', 'sim', 'sim', 'tudo ok', 'teste3', 16, 'teste5', 'teste3', 22),
(93, '2021-08-03', '2022-08-03', '3.4', 12560, 'teste2', 'teste1', 'nao', 'nao', 'sim', 'sim', 'tudo ok', 'teste3', 57, 'teste5', 'teste4', 76),
(94, '2022-08-04', '2023-08-04', '3.4', 12560, 'teste2', 'teste1', 'nao', 'nao', 'sim', 'sim', 'tudo ok', 'teste3', 57, 'teste5', 'teste4', 76),
(95, '2020-08-20', '2021-08-20', '2.5', 23450, 'teste2', 'teste1', 'nao', 'nao', 'nao', 'nao', 'ok', 'teste3', 57, 'teste5', 'teste4', 77),
(96, '2021-08-03', '2022-08-03', '2.8', 35000, 'teste1', 'teste2', 'sim', 'nao', 'nao', 'sim', 'tudo ok', 'teste3', 8, 'teste5', 'teste4', 59),
(97, '2020-08-10', '2021-08-10', '2.9', 23000, 'teste2', 'teste1', 'nao', 'nao', 'sim', 'sim', 'ok', 'teste3', 58, 'teste5', 'teste4', 78),
(98, '2021-08-12', '2022-08-12', '3.5', 33450, 'teste2', 'teste1', 'sim', 'sim', 'sim', 'sim', 'ok', 'teste3', 58, 'teste5', 'teste4', 78);
...
CREATE TABLE `tipo_veiculo` (
  ...
  `tipo_veiculo` varchar(80) COLLATE latin1_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
INSERT INTO `tipo_veiculo` (`codtipo_veiculo`, `tipo_veiculo`) VALUES
(5, 'caminhao'),
(1, 'carro'),
(4, 'moto');
...
(73, 'JZI0739', 'carros', 'branca', '417', NULL, '2019-09-12', NULL, NULL, 55),
(74, 'JNP4089', 'carros', 'branco', '7965', '21', '20020-08-12', NULL, NULL, 56),
(75, 'LUN1777', 'carros', 'branco', '100 2.8 V6', 'Acura', '2021-08-03', NULL, NULL, 5),
(76, 'MMZ4688', 'carros', 'azul', 'Fiesta CLX 1.4i 16V 3p e 5p', 'Acura', '2021-08-03', NULL, NULL, 57),
(77, 'KIG2860', 'motos', 'azul', 'FZR 1000', 'ADLY', '2021-08-03', NULL, NULL, 57),
(78, 'HUC5940', 'carros', '', 'A3 1.8 Turbo 5p Mec.', 'Acura', '', NULL, NULL, 58);
...
ALTER TABLE `marca_veiculo`
  ADD PRIMARY KEY (`codmarca_veiculo`,`tipo_veiculo_codtipo_veiculo`),
  ADD UNIQUE KEY `marca_veiculo_UNIQUE` (`marca_veiculo`),
  ADD KEY `fk_marca_veiculo_tipo_veiculo1_idx` (`tipo_veiculo_codtipo_veiculo`);

--
-- Índices de tabela `modelo_veiculo`
--
ALTER TABLE `modelo_veiculo`
  ADD PRIMARY KEY (`codmodelo_veiculo`,`marca_veiculo_codmarca_veiculo`,`ano_cod_ano`),
  ADD UNIQUE KEY `modelo_veiculo_UNIQUE` (`modelo_veiculo`),
  ADD KEY `fk_modelo_veiculo_ano1_idx` (`ano_cod_ano`),
  ADD KEY `fk_modelo_veiculo_marca_veiculo1_idx` (`marca_veiculo_codmarca_veiculo`);

--
-- Índices de tabela `proxima_troca`
--
ALTER TABLE `proxima_troca`
  ADD PRIMARY KEY (`codproxima_troca`,`servicos_cod_servicos`),
  ADD KEY `fk_proxima_troca_servicos1_idx` (`servicos_cod_servicos`);
...
ALTER TABLE `tipo_veiculo`
  ADD PRIMARY KEY (`codtipo_veiculo`),
  ADD UNIQUE KEY `tipo_veiculo_UNIQUE` (`tipo_veiculo`);
...
--
ALTER TABLE `ano`
  MODIFY `cod_ano` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
--
-- AUTO_INCREMENT de tabela `cliente`
--
ALTER TABLE `cliente`
  MODIFY `codcliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
--
-- AUTO_INCREMENT de tabela `marca_veiculo`
--
ALTER TABLE `marca_veiculo`
  MODIFY `codmarca_veiculo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=157;
--
-- AUTO_INCREMENT de tabela `modelo_veiculo`
--
ALTER TABLE `modelo_veiculo`
  MODIFY `codmodelo_veiculo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
-- AUTO_INCREMENT de tabela `proxima_troca`
--
ALTER TABLE `proxima_troca`
  MODIFY `codproxima_troca` int NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `servicos`
--
ALTER TABLE `servicos`
  MODIFY `cod_servicos` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
--
-- AUTO_INCREMENT de tabela `tipo_veiculo`
--
ALTER TABLE `tipo_veiculo`
  MODIFY `codtipo_veiculo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `veiculo`
  MODIFY `cod_veiculo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
--
-- Restrições para dumps de tabelas
--

--
-- Restrições para tabelas `marca_veiculo`
--
ALTER TABLE `marca_veiculo`
  ADD CONSTRAINT `fk_marca_veiculo_tipo_veiculo1` FOREIGN KEY (`tipo_veiculo_codtipo_veiculo`) REFERENCES `tipo_veiculo` (`codtipo_veiculo`);

--
-- Restrições para tabelas `modelo_veiculo`
--
ALTER TABLE `modelo_veiculo`
  ADD CONSTRAINT `fk_modelo_veiculo_ano1` FOREIGN KEY (`ano_cod_ano`) REFERENCES `ano` (`cod_ano`),
  ADD CONSTRAINT `fk_modelo_veiculo_marca_veiculo1` FOREIGN KEY (`marca_veiculo_codmarca_veiculo`) REFERENCES `marca_veiculo` (`codmarca_veiculo`);

--
-- Restrições para tabelas `proxima_troca`
--
ALTER TABLE `proxima_troca`
  ADD CONSTRAINT `fk_proxima_troca_servicos1` FOREIGN KEY (`servicos_cod_servicos`) REFERENCES `servicos` (`cod_servicos`);
