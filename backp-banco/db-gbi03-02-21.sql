...
--
-- Host: localhost:3306
-- Tempo de geração: 03/03/2021 às 06:03
...
CREATE TABLE `cliente` (
  ...
  `cpf_cliente` varchar(14) CHARACTER SET latin2 COLLATE latin2_general_ci NOT NULL,
...
INSERT INTO `cliente` (`codcliente`, `nome_cliente`, `sobrenome_cliente`, `telefone1_cliente`, `telefone2_cliente`, `cpf_cliente`, `rg_cliente`, `rua_cliente`, `numero_rua_cliente`, `cidade_cliente`, `uf_cliente`, `data_nascimento_cliente`, `sexo_cliente`, `bairro_cliente`) VALUES
(233, 'osvaldo', 'Theo Silveira', '96984854116', '', '85374890182', '6768768', 'ugugugy', 78798, 'Bagé', 'RS', '2000-09-02', 'masculino', 'iuyui'),
(234, 'fabio', 'vasques', '53999367651', '', '02041884070', '1096853931', 'joaquim gasso borges', 841, 'Bagé', 'RS', '1987-11-17', 'masculino', 'pedra branca'),
(235, 'ana sonia', 'da silva', '68678687', '', '27202713306', '68687', 'uygygy', 7887, 'Bagé', 'RS', '8768-06-08', 'femenino', 'yiuyi'),
(236, 'Julia Clara', 'Gomes', '588888', '', '62945853922', '88888', 'Centro', 325, 'Bagé', 'RS', '2007-03-02', 'femenino', 'Centro'),
(237, 'Sarah Clara', 'Nair Nogueira', '78789787989', '', '90447776029', '787987', 'chico mendes', 113, 'Bagé', 'RS', '1979-05-25', 'femenino', 'getulio vargas'),
(238, 'tomas ', 'pedroso cardoso', '76876876', '678678', '69436357001', '678678', 'uiyiuyiu', 779, 'Bagé', 'RS', '0008-06-07', 'masculino', 'uyiyui'),
(239, 'rua benicio', 'da conceicao', '77878', '786786', '35946569007', '678678', 'uyuyut', 654, 'Bagé', 'RS', '7868-06-07', 'masculino', 'huiyui'),
(240, 'joao ', 'noah rocha', '6767768', '7678687', '92331963053', '8687', 'yiyiyuy', 123456, 'Bagé', 'RS', '0007-07-06', 'masculino', 'jouoi');
...
--
ALTER TABLE `cliente`
  MODIFY `codcliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=241;
--
