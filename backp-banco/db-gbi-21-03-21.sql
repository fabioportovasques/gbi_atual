...
--
-- Host: localhost:3306
-- Tempo de geração: 20/03/2021 às 20:57
...
(2, 'Daniela Vanessa', 'pires', '(85) 3664-8508', '(85) 98869-4051', '296.344.183-50', '182249712', 'Rua Doutor Joaquim J. Furtado', 3232, 'Caucaia', 'CE', '1987-11-17', 'femenino', 'Capuan', 61615320),
(5, 'fabio', 'vasques', '(53) 99936-7651', '(', '020.418.840-70', '', 'Rua Joaquim Gasso', 841, 'Bagé', 'RS', '', NULL, 'Pedras Brancas', 96418260),
...
(7, 'Melissa Cristiane', 'Clarice Brito', '(98) 2632-8711', '(', '395.376.551-56', '', 'Travessa Manoel Ferreira Lima', 435, 'São Luís', 'MA', '', NULL, 'Liberdade', 65037230),
(8, 'Renan Iago', 'Brito', '(86) 3675-1518', '(', '420.482.956-22', '', 'Quadra 317', 5545, 'Teresina', 'PI', '', NULL, 'Itararé', 64078410);
...
INSERT INTO `usuarios` (`cod_login`, `nome`, `email`, `senha`, `ip`) VALUES
...
(3, 'MYI1864', 'Carro', 'BRANCO', 'Gol', 'Volskswagen', '', NULL, NULL, 5),
...
--
ALTER TABLE `cliente`
  MODIFY `codcliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `usuarios`
  MODIFY `cod_login` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `veiculo`
--
ALTER TABLE `veiculo`
  MODIFY `cod_veiculo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
