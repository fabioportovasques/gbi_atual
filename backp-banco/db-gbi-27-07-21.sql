...
--
-- Host: localhost:3306
-- Tempo de geração: 27/07/2021 às 09:56
...
--
ALTER TABLE `marca_veiculo`
  MODIFY `codmarca_veiculo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT de tabela `modelo_veiculo`
--
ALTER TABLE `modelo_veiculo`
  MODIFY `codmodelo_veiculo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
