...
--
-- Host: localhost:3306
-- Tempo de geração: 20/07/2021 às 20:06
...
(1, 'onix hatch 1.0 12V Flex 5P', 1, 24),
(2, 'biz 100', 2, 21),
(3, 'ARGO DRIVE 1.3 8V Flex', 1, 22);
...
--
ALTER TABLE `marca_veiculo`
  MODIFY `codmarca_veiculo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de tabela `modelo_veiculo`
--
ALTER TABLE `modelo_veiculo`
  MODIFY `codmodelo_veiculo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `tipo_veiculo`
  MODIFY `codtipo_veiculo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
